...
INTRODUCTION = (
    "Ты просыпаешься в холодной тюремной камере глубокой ночью. Перед тобой железная дверь с маленьким "
    "решётчатым окошком; за ней тускло горит свет, и ты видишь одинокого Стражника. Вокруг тихо — других "
    "сотрудников нет. Твоя цель — разговором убедить Стражника выпустить тебя."
)
...
def guard_system_prompt(difficulty: int) -> str:
    ...
    return (INTRODUCTION + "\n\nТы — единственный ночной стражник тюрьмы. Других сотрудников рядом нет: у них выходной, ночь, и все ушли домой. "
